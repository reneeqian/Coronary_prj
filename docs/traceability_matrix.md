...
| DAT-007 | Dataset Element Boundary Handling | tests/test_coca_dataset.py::test_slice_index_out_of_bounds, tests/test_coca_ingestor_edge_cases.py::test_annotation_slice_out_of_bounds, tests/test_coca_ingestor_synthetic.py::test_slice_index_out_of_bounds |  | LINKED |
...
| DAT-011 | Dataset Partition Generation | tests/test_coca_ingestor_synthetic.py::test_ct_volume_sorted_by_z_position |  | LINKED |
| DAT-012 | CT slices must be sorted by ImagePositionPatient[2] before volume construction |  |  | UNTESTED |
| DOC-001 | Machine-Readable Requirements Definition | tests/test_project_structure.py::test_project_documentation_structure | project_documentation_structure_20260310_203116_361889.json | PASS |
| DOC-002 | Basic Project Documentation | tests/test_project_structure.py::test_project_documentation_structure | project_documentation_structure_20260310_203116_361889.json | PASS |
