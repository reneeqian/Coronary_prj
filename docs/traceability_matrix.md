...
**Overall Score:** 90.1%  **Grade:** A

*Generated at 2026-05-21T04:33:54.378485+00:00*
...
| DOC-001 | Machine-Readable Requirements Definition | tests/test_project_structure.py::test_project_documentation_structure, tests/test_project_structure.py::test_soup_inventory_complete | soup_inventory_complete_20260520_213348_875334.json | PASS |
...
| MOD-005 | Segmentation Performance Acceptance Criterion | tests/test_models.py::test_segmentation_min_dice_threshold_is_configured |  | LINKED |
| MOD-006 | Regression Performance Acceptance Criterion | tests/test_models.py::test_regression_max_mae_threshold_is_configured |  | LINKED |
...
| RSK-001 | Missed Calcium Detection (False Negative) | tests/test_risk_controls.py::test_segmentation_threshold_constant_is_sensible |  | LINKED |
| RSK-002 | Over-Estimation of Calcium Score (False Positive) | tests/test_risk_controls.py::test_negative_score_clamped_before_log1p, tests/test_risk_controls.py::test_regression_threshold_constant_is_sensible |  | LINKED |
| RSK-003 | Silent Ingestion Failure | tests/test_risk_controls.py::test_nongated_ingestor_raises_dataset_structure_error_on_missing_xlsx, tests/test_risk_controls.py::test_ood_guard_warns_on_extreme_hu | rsk003_ood_guard_20260520_213349_060595.json | PASS |
| RSK-004 | Numerical Instability in Log-Transformed Targets | tests/test_risk_controls.py::test_log1p_target_is_always_finite |  | LINKED |
...
| SYS-007 | Intended Use | tests/test_system_architecture.py::test_intended_use_statement_is_advisory |  | LINKED |
...
| TSK-006 | Slice-Broadcast Target Design | tests/test_coronary_calcium_task.py::test_gated_task_all_slices_receive_target_tensor, tests/test_nongated_calcium_score_task.py::test_target_broadcast_identical_across_slices |  | LINKED |
